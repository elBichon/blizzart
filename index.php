...
<html>
  <head lang="fr">
    ...
    <script>
        var myDate = new Date('Sun, 04 May 1991 20:00:00 GMT+02:00');
        var myTimestamp = new Date('Sat, 04 May 1991 20:00:00 GMT+02:00');
        dateAffichage();
    </script>
  </head>
	  ...
	  <h2>Notre équipe</h2>
        <div class="barre">&nbsp</div>
            ...
            <div id="r114" class="row">
                <div id="c1141" class="col-sm-3 col-xs-3"><img id="sponso1" class="img-responsive" src="img/ecole/logo.jpg" alt="Logo sponsor"></div>
                <div id="c1141" class="col-sm-3 col-xs-3"><img id="sponso1" class="img-responsive" src="img/ecole/logo.jpg" alt="Logo sponsor"></div>
                <div id="c1141" class="col-sm-3 col-xs-3"><img id="sponso1" class="img-responsive" src="img/ecole/logo.jpg" alt="Logo sponsor"></div>
                <div id="c1141" class="col-sm-3 col-xs-3"><img id="sponso1" class="img-responsive" src="img/ecole/logo.jpg" alt="Logo sponsor"></div>
            </div>
            <div id="r115" class="row">
                <div id="c1152" class="col-sm-3 col-xs-3"><h4>Votre marque ici</h4></div>
                <div id="c1153" class="col-sm-3 col-xs-3"><h4>Votre marque ici</h4></div>
                <div id="c1154" class="col-sm-3 col-xs-3"><h4>Votre marque ici</h4></div>
                <div id="c1153" class="col-sm-3 col-xs-3"><h4>Votre marque ici</h4></div>
            </div>
    </div>
</div>
